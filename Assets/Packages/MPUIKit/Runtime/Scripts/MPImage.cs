...
namespace MPUIKIT {
    ...
    public class MPImage : Image {
        ...
        [SerializeField] private MaterialSettings m_MaterialSettings;
        ...
        public MaterialSettings MaterialSettings {
            ...
            set {
                if (m_MaterialSettings == value) return;
                m_MaterialSettings = value;
        ...
        public override Material material {
            get {
                if (m_Material && m_MaterialSettings == MaterialSettings.Shared) {
                    return m_Material;
                }
            ...
            set {
                ...
                if (m_Material && m_MaterialSettings == MaterialSettings.Shared && m_Material.shader.name == MpShaderName) {
                    InitValuesFromSharedMaterial();
#if UNITY_EDITOR
                    parseAgainOnValidate = true;
#endif
        ...
        public Pentagon Pentagon {
            get { return m_Pentagon; }
        }

        public Hexagon Hexagon {
            get { return m_Hexagon; }
        }

        public NStarPolygon NStarPolygon {
            get { return m_NStarPolygon; }
        }
        ...
        private Material DynamicMaterial {
            get {
                if (dynamicMaterial == null) {
                    dynamicMaterial = new Material(Shader.Find(MpShaderName));
        ...
        private Sprite ActiveSprite {
            get {
                var overrideSprite1 = overrideSprite;
        ...
        public void UpdateSerializedValuesFromSharedMaterial() {
            if (m_Material && MaterialSettings == MaterialSettings.Shared) {
                InitValuesFromSharedMaterial();
                base.SetMaterialDirty();
            }
        }
