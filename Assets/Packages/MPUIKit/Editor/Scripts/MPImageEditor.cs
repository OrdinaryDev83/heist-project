...
namespace MPUIKIT.Editor {
    ...
    public class MPImageEditor : ImageEditor {
        ...
        protected override void OnEnable() {
            ...
            spMaterialSettings = serializedObject.FindProperty("m_MaterialSettings");
        ...
        private void SharedMaterialGUI() {
            ...
            if (EditorGUI.EndChangeCheck()) {
                ...
                foreach (Object obj in targets) {
                    ((MPImage) obj).MaterialSettings = (MaterialSettings) matSett;
                }
            }
            ...
            EditorGUI.BeginDisabledGroup(spMaterialSettings.enumValueIndex == (int) MaterialSettings.Dynamic);
            {
