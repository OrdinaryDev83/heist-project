...
namespace MPUIKIT.Editor {
    ...
    internal static class MPEditorStyles {
        ...
        private static void FindMpuiKitIconsDirectory() {
            ...
            _mpuiKitIconsDirectory = System.IO.Path.Combine(iconDirectory.ToString(), $"Icons{System.IO.Path.DirectorySeparatorChar}")
                .Replace(unityRoot.ToString() + System.IO.Path.DirectorySeparatorChar, string.Empty);
        }
